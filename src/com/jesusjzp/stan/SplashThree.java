...
public class SplashThree extends Activity {
	RelativeLayout ll;
	Button btn_next;
	Button btn_last;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.splashthree);
    	...
    	ll.setBackgroundResource(R.drawable.z3);
...
//        x.postDelayed(new StartThread(), 3000);
    	...
    	btn_last.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				...
				SplashThree.this.finish();				
			}
        });
    	
    	btn_next.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
				startActivity(new Intent(getApplication(),SplashFour.class));
				SplashThree.this.finish();				
			}
        });
	};
